    ...
    class data extends db{
        ...
        function adminLogin($t1, $t2){
            ...
            if($result >0){
                ...
                header("Location:indexs.php?msg=Invalid Credentials");
            }
        }

        function addnewuser($name,$pasword,$email,$photo,$type){
            ...
            $q="INSERT INTO userdata(id, name, email, pass,photo,type)VALUES('','$name','$email','$pasword','$photo','$type')";
        ...
        function addregisteruser($name,$pasword,$email,$photo,$type){
            ...
            if($this->connection->exec($q)) {
                header("Location:index.php?msg=New Add done");
            }
            else {
        ...
        function addbook($bookpic, $bookname, $bookdetail, $bookauthor, $bookpub, $branch, $bookprice,$bookrent, $bookquantity, $bookava) {
            ...
            $q="INSERT INTO book (id,bookpic,bookname, bookdetail, bookauthor, bookpub, branch, bookprice,bookquantity,bookava,bookrent)VALUES('','$bookpic', '$bookname', '$bookdetail', '$bookauthor', '$bookpub', '$branch', '$bookprice','$bookquantity','$bookava','$bookrent')";
